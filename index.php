...
global $controller;
define("ENVIRONMENT", "DEVELOPMENT"); // We using this in lib/UltErrorHandler class
define("HANDLE_ERROR", "TRUE");

$_REQUEST['outputType'] = isset($_REQUEST['outputType']) ? $_REQUEST['outputType'] : 'json';
...
class controller
{
    ...
    function __construct($class_name,$outputType='x'){  
        ...
        $ultErrorHandler = new lib\UltErrorHandlerAdvance();
