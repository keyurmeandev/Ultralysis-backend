...
class StockCoverPage extends config\UlConfig {
    /*     * ***
	 * go()
    ...
    public function buildDataArray() {
		...
		$configurationCheck = new config\ConfigurationCheck($this->settingVars, $this->queryVars);
        $configurationCheck->buildDataArray(array($skuField, $storeField));
		...
		$this->storeID = $this->settingVars->dataArray[$storeField]["ID"];
