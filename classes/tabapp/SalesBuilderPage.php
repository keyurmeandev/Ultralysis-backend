...
class SalesBuilderPage extends \classes\SummaryPage {
    ...
    public function getMarketList() {
        ...
        */
        list($dataList, $data) = $this->getProductStoreFiltersData('storeDataHelper');
        $this->jsonOutput["marketSelectionTabs"][] = ['dataList'=>$dataList,'data'=>$data];
            ...
            if (!empty($dataHelpers)) {
                ...
                foreach ($dataHelpers as $key => $account) {
                    ...
                    $this->jsonOutput["allProductsList"][] = [
                        ...
                        'data'=>$account, 
                        'selected'=> ($strAllLen == $cntr) ? true : false,
                        'selectedDataList'=>[],
    ...
    public function getProductStoreFiltersData($filter = "productDataHelper", $customSelectPart = '', $customQueryPart = '', $customHavingPart = '', $productAccount = '') {
        ...
        if (!empty($dataHelpers)) {
            ...
            if ($account != "") {
                ...
                return array($dataList, $combineAccounts[0]);
            }
