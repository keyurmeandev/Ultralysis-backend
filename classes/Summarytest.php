...
class Summarytest extends config\UlConfig {
    ...
    public function fetchConfig()
    {
        if (isset($_REQUEST["fetchConfig"]) && !empty($_REQUEST["fetchConfig"]) && $_REQUEST["fetchConfig"] == 'true') {
            ...
            $summaryStockSelection = $this->getPageConfiguration('summary_stock_selection', $this->settingVars->pageID);
            ...
            if(!empty($summaryStockSelection) && isset($summaryStockSelection[0])) {
                $this->jsonOutput['summaryStockSelection'] = $summaryStockSelection[0];
            }
        }
    }
