...
class AdvanceSummaryPage extends config\UlConfig {
    ...
    public function go($settingVars) {
        ...
        $this->pageName = $settingVars->pageName = (empty($settingVars->pageName)) ? 'AdvanceSummaryPage' : $settingVars->pageName; // set pageName in settingVars
