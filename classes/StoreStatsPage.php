...
class StoreStatsPage extends config\UlConfig {
    ...
    public function go($settingVars) {
        ...
        $this->pageName = $settingVars->pageName = (empty($settingVars->pageName)) ? 'StoreStatsPage' : $settingVars->pageName; // set pageName in settingVars
    ...
    public function fetch_all_pod_data() {
        ...
        if ($this->settingVars->isDynamicPage) {
            ...
            if($this->pageName == 'CAT_SUMMARY_PAGE') {
                if(isset($this->settingVars->catStoreStatsPageDataTwoField) && $this->settingVars->catStoreStatsPageDataTwoField != '')
                {
                    $query  = "SELECT db_column FROM ".$this->settingVars->clientconfigtable." WHERE cid=".$this->settingVars->aid." AND db_table='".$this->settingVars->skutable."' AND csv_column = '".$this->settingVars->catStoreStatsPageDataTwoField."'";
