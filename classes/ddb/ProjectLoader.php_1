...
class ProjectLoader extends config\UlConfig{
    ...
    *****/
    public function go($settingVars){ 
        ...
        if(isset($this->queryVars->projectConfiguration['ddb_time_selection']) && $this->queryVars->projectConfiguration['ddb_time_selection'] != '') {
            $this->jsonOutput['timeSelectionWeeks'] = $this->queryVars->projectConfiguration['ddb_time_selection'];
        }
    ...
    *****/
    public function fetchTimeSelectionData(){
        ...
        if ($this->settingVars->timeSelectionUnit != 'date' && $this->settingVars->timeSelectionUnit != 'days')
