    ...
    public function go($settingVars) {
        ...
        switch ($this->projectType)
        {
            ...
            case 'lcl':
                ...
                if (isset($this->settingVars->showLyRangeTextInTimeSelection))
                    $this->jsonOutput['showLyRangeTextInTimeSelection'] = $this->settingVars->showLyRangeTextInTimeSelection;
                
                if (isset($this->settingVars->showVsDropdownTimeSelection))
                    $this->jsonOutput['showVsDropdownTimeSelection'] = $this->settingVars->showVsDropdownTimeSelection;
