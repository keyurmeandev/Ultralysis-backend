...
class RetailerReport extends config\UlConfig {
    ...
    function genarateRetailerReport()
    {
        ...
        // echo '/usr/bin/perl '.dirname(__FILE__).'/../batch/RetailerReport.pl "'.$filePath.'" "'.$csvDataFilePath.'" "'.$maxMydate.'" "'.$brands.'" "'.$supplierList.'" "'.$topFilterValue.'" "'.$timeFilterSettings.'" "'.$skipRankCnt.'"';
        // exit();
        $result = shell_exec('/usr/bin/perl '.dirname(__FILE__).'/../batch/RetailerReport.pl "'.$filePath.'" "'.$csvDataFilePath.'" "'.$maxMydate.'" "'.$brands.'" "'.$supplierList.'" "'.$topFilterValue.'" "'.$timeFilterSettings.'" "'.$skipRankCnt.'"');
