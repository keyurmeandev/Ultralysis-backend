...
class UbTescoSalesBuilder extends BaseMults {

    public function __construct($aid, $projectID, $gids) {
        $this->maintable = "ub_mults";
	   ...
	   $this->pageArray["EXE_SUMMARY_PAGE"]["DH"] = "";
		...
		$this->pageArray["PROJECT_NAME"] = "UB Tesco Sales Builder";
        ...
        $this->uploadDir = __DIR__ . "/../../".$_REQUEST['projectDIR']."/templates/UB/";
        $this->uploadUrl = $this->get_full_url()."/".$_REQUEST['projectDIR']."/templates/UB/";
