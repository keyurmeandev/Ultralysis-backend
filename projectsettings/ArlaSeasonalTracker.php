...
class ArlaSeasonalTracker extends BaseLcl {

    public function __construct($aid, $projectID, $gid) {
        $this->maintable = "seasonal_tracker_arla";
        ...
        $this->registeredProductCodesFilePath = $_SERVER['DOCUMENT_ROOT']."/data-uploader/project/uploads/arla";
        ...
        $this->timetable  = "seasonal_tracker_arla";
        $this->weekperiod = "";
        $this->yearperiod = "";
    ...
    public function prepareFromToDateRange() {
        ...
        if (is_array($timeframe) && !empty($timeframe)) {
            ...
            if (is_array($result) && !empty($result)) {
                ...
                $this->fromToDateRange = ['fromDay' => $minDate[2], 'fromMonth' => $minDate[1], 'toDay' => '31', 'toMonth' => '01', 'maxDate' => $maxDate];
            }
        } else {
