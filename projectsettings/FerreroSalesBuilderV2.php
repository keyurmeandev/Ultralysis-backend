...
class FerreroSalesBuilderV2 extends BaseLcl {
    ...
    public function __construct($aid, $projectID, $gids) {
        ...
        /*$this->productLevelToChart = ['product.agg2','product.agg1','product.PNAME_ROLLUP2#product.PIN'];*/
		...
		{	
			...
			$this->tableArray['store']['link'] 		= " WHERE ".$this->storetable.".gid IN (".$this->GID.") ". 
														...
														" AND ".$this->territoryField." =  '".$_REQUEST['filtered_territory']."' ".$commonFilterQueryPart;
