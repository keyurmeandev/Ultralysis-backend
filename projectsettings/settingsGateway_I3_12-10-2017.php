...
class settingsGateway {
    ...
    public function initiateSettingVars() {
        ...
        switch ($this->projectID) {
            ...
            case 726: // Maple Leaf Master
                $varsClass = new MapleLeafCanadaMults($this->aid,$this->projectID, array(10));
                break;

            case 729: // Vileda Master
                $varsClass = new ViledaCanadaMults($this->aid,$this->projectID, array(10));
                break;
                
            case 733: // UB Tesco Formats Alternative
                $varsClass = new UbTescoFormatAlternative($this->aid,$this->projectID,array(1));
                break;
            ...
            case 735: // Agbarr Relay Plus
                if ($_REQUEST['SIF'] == "YES") {
                    $varsClass = new commonRetailLinkDaily(array_merge($commonParams,array('clientID' => "TOPPS")));
                    $varsClass->setCluster();
                } else {
                   $varsClass = new commonMultsSummary(array_merge($commonParams, array('clientID' => "TOPPS", 'footerCompanyName' => "Topps")));
                }
                break;
            ...
            case 727: // Maple Leaf Master DDB
                $varsClass = new MapleLeafCanadaMults($this->aid,$this->projectID, array(10));
                break;

            case 730: // Vileda Master DDB
                $varsClass = new ViledaCanadaMults($this->aid,$this->projectID, array(10));
                break;

            case 736: // Ferrero Tesco Ireland DDB
                $varsClass = new FerreroTescoIreland($this->aid,$this->projectID);
                break;
