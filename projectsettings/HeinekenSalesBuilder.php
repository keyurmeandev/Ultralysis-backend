...
class HeinekenSalesBuilder extends BaseLcl {
    ...
    public function __construct($aid, $projectID, $gids) {
        ...
        $this->uploadDir = __DIR__ . "/../../".$_REQUEST['projectDIR']."/templates/HEINEKEN/";
        $this->uploadUrl = $this->get_full_url()."/".$_REQUEST['projectDIR']."/templates/HEINEKEN/";
