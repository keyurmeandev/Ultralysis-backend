...
class FerreroImpulseViewJS extends BaseTsdDailyReport {

    public function __construct($accountID,$projectID) {

        $this->maintable            = "ferrero_sku_store_daily_14";        
        $this->tesco_depot_daily    = "ferrero_tesco_depot_daily";

        $this->sku_supplier_daily   = "ferrero_sku_supplier_daily_14";
        ...
        $this->retailerLogo         = "sainsburys.png";
