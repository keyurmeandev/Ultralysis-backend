...
class PataksLcl extends BaseLcl {
    ...
    public function __construct($aid, $projectID) {
        ...
        $this->measureArray['M6']['ALIASE'] = "RATEOFSALE";
        $this->measureArray['M6']['measureName'] = "RATE OF SALE";
        $this->measureArray['M6']['attr'] = "COUNT";
        $this->measureArray['M6']['dataDecimalPlaces']   = 2;

        $this->performanceTabMappings['rateOfSale'] = 'M6';
