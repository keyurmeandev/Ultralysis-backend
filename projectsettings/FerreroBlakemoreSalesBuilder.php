...
class FerreroBlakemoreSalesBuilder extends BaseMults {

    public function __construct($aid, $projectID, $gids) {
        $this->maintable = "ferrero_blakemore";
        ...
        $this->ProjectCases="CUSTOMER_COUNT";
        ...
        $this->pageArray["MEASURE_SELECTION_LIST"] = array(
            ...
            array('measureID' => 5, 'jsonKey'=>'CASES', 'measureName' => 'Customer Count', 'selected' => false )
        );        
