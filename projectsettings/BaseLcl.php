...
class BaseLcl {
    ...
    public $isActiveStoreFromDateLastSoldStoreTbl = false;
    
    // [START] SALES BUILDER
        public $templateImgMinWidth=1024;
        public $templateImgMinHeight=768;
    // [END] SALES BUILDER
    ...
    public function __construct($gids=array(10)) {
        ...
        $this->activetable          = "active_stores";
        ...
        $this->dateLastSold = $this->storetable.'.dateLastSold';
        $this->ferreroIrelandOrdersTable = "ferrero_ireland_orders";
        ...
        ***/
		...
		//category summary pods vars        
        $this->catSummaryPageDataTwoField = "CATEGORY";
        ...
        */
        ...
        $this->geoHelperTables = $this->tableArray['store']['tables'];
        $this->geoHelperLink = $this->tableArray['store']['link'];
        ...
        //SETTING FOR THE DATELASTSOLD DATE CHECKING
        if(!empty($gids) && in_array(10, $gids)){
            $this->isActiveStoreFromDateLastSoldStoreTbl = true;
        }
    ...
    public function configureClassVars()
    {
        ...
        $this->copy_tablename = $this->tablename = " " . $this->maintable . "," . $this->timetable . "," . $this->skutable . "," . $this->storetable;
        ...
        $this->timeHelperLink = " JOIN (SELECT distinct " . $this->maintable . "." . $this->dateperiod . "," . 
                                $this->maintable . ".GID FROM " . $this->maintable . " ) b ON ".
    ...
    public function pageArray()
	{
		...
		$this->pageArray["CONSOLIDATED_DISTRIBUTION"]["planoSellingAccounts"] = "F32-F11-F15";
    ...
    public function dataArray()
    {
        ...
        $this->dataArray['F32']['NAME'] = $this->productplanotable .'.article';
        $this->dataArray['F32']['NAME_ALIASE'] = 'PIN';
    ...
    public function getAllClientConfig() {
        ...
        $redisOutput = $redisCache->checkAndReadByStaticHashFromCache('lcl_data_manager_configuration');
    ...
    public function getMeasureSettings()
    {
        ...
        $redisCache = new utils\RedisCache($queryVars);
        $redisOutput = $redisCache->checkAndReadByStaticHashFromCache('lcl_measure_configuration');
        ...
        if ($queryVars->isInitialisePage || $redisOutput === false) {
            ...
            $this->performanceTabMappings['volumeOverTime'] = "M7";
    ...
    public function getAllPageConfiguration(){
        ...
        $redisCache = new utils\RedisCache($queryVars);
        $redisOutput = $redisCache->checkAndReadByStaticHashFromCache('lcl_pages_configuration');
	...
	public function getClientProjectName() {
        ...
        $redisCache = new utils\RedisCache($queryVars);
        $redisOutput = $redisCache->checkAndReadByStaticHashFromCache('lcl_project_name');
