...
class PandgMultsDailySalesBuilder extends BaseLcl {
    ...
    public function __construct($aid, $projectID, $gids) {
        ...
        $this->clickHereToAddText = "Click here to add Summary Of Commitments";

        $this->timeSelectionUnitOptions = array(
            array("unit" => "date", "label" => "Daily", "pickActionLabel" => "Day", "selected" => false),
            array("unit" => "weekYear", "label" => "Weekly","pickActionLabel" => "Week", "selected" => true),
        );

        $this->productLevelToChart = ['product.PNAME#product.PIN','product.agg1'];
