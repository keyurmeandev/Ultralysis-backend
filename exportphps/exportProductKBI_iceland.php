...
$objPHPExcel 	= $objReader->load("templates/product_kbi_export_template_iceland.xlsx");
...
function addData($data){
	...
	foreach($data as $r => $dataRow) {
		...
		$objPHPExcel->getActiveSheet()->setCellValue('A'.$row, $dataRow->TPNB)//TPNB
					      ...
					      ->setCellValue('V'.$row, $dataRow->RANGED_TP)//RANGED TP
					      ->setCellValue('W'.$row, $dataRow->SCANNED_TP);//SCANNED TP
	}
